...
def netz(n):
    ...
    s = math.ceil(20*n_train ** (1 / 3) * np.log(n_train))
    p.append(1)
    p.insert(0, d)
    # netzwerk
...
if __name__ == '__main__':
    pool = mp.Pool(3)
    list_iterable = list(range(100,251,10))+list(range(300, 501, 50))+list(range(600,1501,100))
    results = [pool.apply_async(netz, args = (n,)) for n in list_iterable*100]
